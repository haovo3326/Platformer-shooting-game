...
public class MapArsenal {
    public static Map createMap1(){
        return new Map(new Obstacle[]{
                new Obstacle(new Vector2(200, 700), new Vector2(1400, 20), Color.GRAY, 2),
                new Obstacle(new Vector2(400, 600), new Vector2(1000, 20), Color.GRAY, 1),
                new Obstacle(new Vector2(600, 500), new Vector2(600, 20), Color.GRAY, 0)
        }, 3);
    }
